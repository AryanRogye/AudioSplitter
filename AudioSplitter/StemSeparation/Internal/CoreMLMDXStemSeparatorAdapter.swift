...
private nonisolated enum CoreMLStemSeparatorEngine {
    ...
    private static func write(
        ...
        let baseDirectory = fileManager.urls(for: .documentDirectory, in: .userDomainMask)[0]
